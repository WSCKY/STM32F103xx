...
static void EncoderA_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(ENCODER_A_GPIO_PORT_CLK_1 | ENCODER_A_GPIO_PORT_CLK_2, ENABLE);

	/* Configure GPIO PIN as alternate function mode */
	GPIO_InitStructure.GPIO_Pin = ENCODER_A_GPIO_PIN_1;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(ENCODER_A_GPIO_PORT_1, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = ENCODER_A_GPIO_PIN_2;
	GPIO_Init(ENCODER_A_GPIO_PORT_2, &GPIO_InitStructure);
